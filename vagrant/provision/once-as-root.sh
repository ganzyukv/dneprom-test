...
apt-get install -y php7.3-curl php7.3-cli php7.3-intl php7.3-mysqlnd php7.3-gd php7.3-fpm php7.3-mbstring php7.3-xml unzip nginx mariadb-server-10.0 php.xdebug
...
ln -sfn /app/vagrant/nginx/app.conf /etc/nginx/sites-enabled/app.conf
echo "Done!"
